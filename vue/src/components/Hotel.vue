        ...
        <div class="hContents">
          <div class="hCard" v-for="item in displayedData" :key="item.id">
            ...
            <div class="hCardContent">
              ...
              <div class="hCardContentBox"><a>ใกล้กับอุทยาน {{ item.name }}</a></div>
              <div class="hCardContentBoxDetail"><a>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</a></div>
              <div class="hCardReserve">
                <a>ราคาเริ่มต้น xxx บาท</a>
                <a href="/hotel/detail"><button class="hCardReserveBtn">จองห้องพัก</button></a>
              </div>
            </div>
          </div>
        </div>
