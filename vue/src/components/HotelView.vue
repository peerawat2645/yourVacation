<template>
    <div class="hvBody">
      <div class="hvText"><a>ประเภทห้องของคุณ</a><div><a href="/hotel/edit" class="hvblack-button" style="font-size: 18px; color:white; margin-right:0%;">แก้ไขโปรไฟล์</a><a href="/hotel/add" class="hvblack-button" style="font-size: 18px; color:white">add</a></div></div>
      <div class="hvContent">
        <div style="width: 100%;">
            ...
            <div class="hvCard" v-for="item in displayedData" :key="item.id">
              ...
              <div class="hvCardContent">
                <div class="hvCardContentBox">
                  <p>ห้องประเภท {{ item.id }}</p>
                </div>
                <div class="hvCardContentBox"><a>มีจำนวนห้อง {{ item.name }} ห้อง</a></div>
                <div class="hvCardContentBoxDetail"><a>aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa</a></div>
                <div class="hvCardReserve">
                  <a href="/hotel/roomtype/edit"><button class="hvCardReserveBtn">แก้ไข</button></a>
                </div>
              </div>
            </div>
          </div>
